 ...
 * visible window.
 * <p>
 * ZoomageView was made by <a href="https://github.com/jsibbold/zoomage">Jeffrey Sibbold</a> and
 * released under the terms of the <a href="https://www.apache.org/licenses/LICENSE-2.0.html">Apache 2.0</a>
 * license.
 */
public class ZoomageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private Runnable onSingleTapListener;
    ...
    /**
     * This sets a callback for when a touch event has been noticed that is not a zoom.
     */
    public void setOnSingleTapListener(Runnable r) {
        this.onSingleTapListener = r;
    }
    ...
    /**
     * This forces a re-calculation of the image bounds. Use this when resizing the ZoomageView.
     * Also, this is automatically called when a onSizeChanged event gets fired. So normally, you
     * don't want to call this function manually.
     */
