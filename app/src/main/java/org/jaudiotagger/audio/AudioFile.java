...
public class AudioFile {
  ...
  public Tag createDefaultTag() {
    ...
    if (SupportedFileFormat.FLAC.getFileSuffix().contains(extension)) {
      return new FlacTag(VorbisCommentTag.createNewTag(), new ArrayList<MetadataBlockDataPicture>());
    } else if (SupportedFileFormat.OGG.getFileSuffix().contains(extension)) {
      return VorbisCommentTag.createNewTag();
    } else if (SupportedFileFormat.MP4.getFileSuffix().contains(extension)) {
      return new Mp4Tag();
    } else if (SupportedFileFormat.M4A.getFileSuffix().contains(extension)) {
      return new Mp4Tag();
    } else if (SupportedFileFormat.M4P.getFileSuffix().contains(extension)) {
      return new Mp4Tag();
    } else if (SupportedFileFormat.WMA.getFileSuffix().contains(extension)) {
      return new AsfTag();
    } else if (SupportedFileFormat.WAV.getFileSuffix().contains(extension)) {
      return new WavTag(TagOptionSingleton.getInstance().getWavOptions());
    } else if (SupportedFileFormat.RA.getFileSuffix().contains(extension)) {
      return new RealTag();
    } else if (SupportedFileFormat.RM.getFileSuffix().contains(extension)) {
      return new RealTag();
    } else if (SupportedFileFormat.AIF.getFileSuffix().contains(extension)) {
      return new AiffTag();
    } else if (SupportedFileFormat.AIFC.getFileSuffix().contains(extension)) {
      return new AiffTag();
    } else if (SupportedFileFormat.AIFF.getFileSuffix().contains(extension)) {
      return new AiffTag();
    } else if (SupportedFileFormat.DSF.getFileSuffix().contains(extension)) {
